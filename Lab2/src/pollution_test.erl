...
add_value_fail_test() ->
  ...
  M2 = pollution:add_value("Stacja 1", Time, "PM10", 46.3, M1),
  ?assertMatch({error, _}, M2),
  M3 = pollution:add_value("Stacja 1", Time, "PM10", 36.3, M1),
  ?assertMatch({error, _}, M3),
  M4 = pollution:add_value({1,1}, Time, "PM10", 46.3, M1),
  ?assertMatch({error, _}, M4),
  M5 = pollution:add_value({1,1}, Time, "PM10", 36.3, M1),
...
get_station_min_test() ->
  ...
  M4 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,13}}, "PM10", 2.3, M3),

  ?assertMatch(10, pollution:get_station_min("Stacja 1", "PM10", M2)),
  ?assertMatch(5, pollution:get_station_min({1,1}, "PM10", M3)),
  ?assertMatch(2.3, pollution:get_station_min("Stacja 1", "PM10", M4)).
